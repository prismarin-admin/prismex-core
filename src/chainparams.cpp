...
{
    const char* pszTimestamp = "Prismex Genesis 2026 - Onyx Rises - The Old System Falls";

// PRISMEX TOKENOMICS ALLOCATION (15% PRE-MINE)
// Organisasi di-lock 4 tahun, cair maksimal 2% per bulan lewat AI voting
// Public Mining: 85% (17,850,000 PRX)
// Airdrop: 5% (1,050,000 PRX)
// Founder: 4% (840,000 PRX) - Wallet pribadi, bebas dikelola
// Onyx: 3% (630,000 PRX) - Diurus AI Onyx
// Obsidian: 2% (420,000 PRX) - Diurus AI Obsidian
// Aegis: 1% (210,000 PRX) - Diurus AI Aegis
// Treasury: Diambil 0.1% dari tiap transaksi, dikelola AI Treasury
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.prismex.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.prismextools.com");
        vSeeds.emplace_back("dnsseed.prismexpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.prismextools.com");
        vSeeds.emplace_back("seed-b.prismex.loshan.co.uk");
