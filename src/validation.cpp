    ...
    for (const CTxInput& txin : tx.GetInputs())
    {
        ...
        if (ptxConflicting) {
            if (!setConflicts.count(ptxConflicting->GetHash()))
            {
                ...
                // Prismex: Only support BIP125 RBF when -mempoolreplacement arg is set
...
// PRISMEX TREASURY ADDRESS (0.1% tiap transaksi)
const std::string TREASURY_ADDRESS = "PRX_TREASURY_PLACEHOLDER";
const std::string ONYX_ADDRESS = "ONYX_ADDRESS_PLACEHOLDER";
const std::string OBSIDIAN_ADDRESS = "OBSIDIAN_ADDRESS_PLACEHOLDER";
const std::string AEGIS_ADDRESS = "AEGIS_ADDRESS_PLACEHOLDER";
const std::string FOUNDER_ADDRESS = "FOUNDER_ADDRESS_PLACEHOLDER";
