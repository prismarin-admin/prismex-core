...
const char * const BITCOIN_CONF_FILENAME = "prismex.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Prismex";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Prismex";
#else
    // Unix-like
    return pathRet / ".prismex";
#endif
#endif
}
