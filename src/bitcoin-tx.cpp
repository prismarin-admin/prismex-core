...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " prismex-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  prismex-tx [options] <hex-tx> [commands]  Update hex-encoded prismex transaction\n" +
            "or:     prismex-tx [options] -create [commands]   Create hex-encoded prismex transaction\n" +
            "\n";
