...
"""Verify that starting prismex with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start prismex with -h for help text")
        ...
        self.log.info("Start prismex with -version for version information")
        ...
        self.log.info("Start prismexd with -fakearg to make sure it does not start")
