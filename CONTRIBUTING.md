Contributing to Prismex Core
============================

The Prismex Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Prismex Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/prismex-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to prismex-qt
...
The following applies to code changes to the Prismex Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Prismex
Network Protocol consensus changes.

Whether a pull request is merged into Prismex Core rests with the project merge
...
Patches that change Prismex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Prismex consensus, it must have been
...
The project leader is the release manager for each Prismex Core release.
