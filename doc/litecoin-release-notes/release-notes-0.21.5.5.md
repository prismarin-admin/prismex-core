Prismex Core version 0.21.5.5 is now available from:

 <https://download.prismex.org/prismex-0.21.5.5/>.
...
- Replaced the functional test dependency on the external `prismex_scrypt`
