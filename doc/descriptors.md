# Support for Output Descriptors in Prismex Core

Since Prismex Core v0.17, there is support for Output Descriptors. This is a
...
existing Prismex Core wallets, a convenience function `combo` is
